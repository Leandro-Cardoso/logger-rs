...
impl LoggerConfig {
    ...
    pub fn new(directory: impl Into<PathBuf>, max_storage_mb: u64) -> Self {
        Self {
...
mod tests {
    ...
    fn test_create_config() {
        let config = LoggerConfig::new("./test_logs", 50);
    ...
    fn test_invalid_storage_limit() {
        let config = LoggerConfig::new("./logs", 0);
    ...
    fn test_valid_config() {
        let config = LoggerConfig::new("./logs", 100);
